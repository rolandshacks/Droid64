...
public class EmuView extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private Rect bitmapSourceRect = new Rect(0, 0, EmuControl.DISPLAY_X, EmuControl.DISPLAY_Y);
    ...
    public EmuView(Context context, AttributeSet attrs) {
        ...
        bitmap = Bitmap.createBitmap(EmuControl.DISPLAY_X, EmuControl.DISPLAY_Y, Bitmap.Config.ARGB_8888);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
    	viewDestroyed = false;
        startRendering();
        EmuControl.instance().resume();
    }

    @Override
    public void surfaceDestroyed(SurfaceHolder holder) {
    	viewDestroyed = true;
        EmuControl.instance().pause();
        stopRendering();
    }
    ...
    private void updateBitmap() {
        ...
        byte[] rawData = EmuControl.instance().lockTextureData();
        if (null == rawData) {
            return;
        }
        ...
        EmuControl.instance().unlockTextureData();
    ...
    private void drawOverlay(Canvas canvas) {
        ...
        double emuUpdatePerSec = EmuControl.instance().getUpdatesPerSecond();
        ...
        int stick = EmuControl.instance().getStick();
