...
public class EmuViewRenderer extends Renderer {
    ...
    private int texture;
    private int textureWidth = EmuControl.DISPLAY_X;
    private int textureHeight = EmuControl.DISPLAY_Y;
    ...
    @Override
    protected void init() {
        packedTextures = EmuPrefs.instance().isTextureCompressionEnabled();
    }
    ...
    protected void draw() {
        ...
        boolean textureFiltering = EmuPrefs.instance().isAntialiasingEnabled();
