...
public class Control {
	...
	private void emuLoop() {
		...
		if (!Thread.interrupted()) {
			...
			//sendCommand(prefs.isDriveEmulationEnabled() ? NativeInterface.COMMAND_TRUEDRIVE_ON : NativeInterface.COMMAND_TRUEDRIVE_OFF);
			//sendCommand(prefs.isJoystickSwapEnabled() ? NativeInterface.COMMAND_JOYSTICK_SWAP_ON : NativeInterface.COMMAND_JOYSTICK_SWAP_OFF);
	...
	public void setTrueDriveMode(boolean enabled) {
		sendCommand(enabled ? NativeInterface.COMMAND_TRUEDRIVE_ON : NativeInterface.COMMAND_TRUEDRIVE_OFF);
	}
