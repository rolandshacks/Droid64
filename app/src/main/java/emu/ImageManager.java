...
public class ImageManager {
	...
	private final static Logger logger = LogManager.getLogger(ImageManager.class.getName());
	...
	public String getSnapshotName() {
		...
		if (null != currentImage) {
			...
			if (null != imageName && !imageName.isEmpty()) {
				...
				if (currentImage.getType() == Image.TYPE_SNAPSHOT && imageName.startsWith("c64-")) {
	...
	/*
	public void attachDisk(AssetManager assets, Image image) {
