...
void IEC::UpdateLEDs(void)
{
    ...
    {
        // TODO
		//update_led(drive[0]->LED, drive[1]->LED, drive[2]->LED, drive[3]->LED);
    }
}
...
const uint8* Drive::getImageData()
{
    return d64Buffer;
}

int Drive::getImageSize()
{
    return d64Size;
}
